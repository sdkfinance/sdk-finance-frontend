  ...
  <contracts-layout :links="links">
    ...
    <contacts :default-filter="defaultFilter">
      <template #default="{ contractsList, isLoading, updateTable }">
        <modal
          v-model="isModalShow"
          :title="$t('pages.contracts.modal.add_custom_contract_for_merchants')"
          width="380px">
...
export default class ContractsMerchantPage extends Vue {

  protected defaultFilter: IContractsFilter = { types: ['merchant'] };
