...
import AppFormTable from '@/components/ui-kit/app-table/app-table-form.vue'
...
<Meta title="ui-framework/AppFormTable" component={ AppFormTable }/>
...
### Default
<Canvas>
  <Story name="Default view" args={{ data, columns, rules }}>
    { Template.bind({}) }
  </Story>
</Canvas>
