...
<script lang="ts">
import type { IApiResponse, IPlainObject, TServerError } from '@sdk5/shared/types';
import { errorNotification } from '@sdk5/shared/utils';
import { OnlyLetterValidator, PhoneValidator, SimpleRequiredValidationRule } from '@sdk5/shared/validation';
import { AppButton, AppForm, AppFormItem, AppInput } from '@sdk5/ui-kit-front-office';
import { Component, Emit, Prop, Ref, Vue, Watch } from 'vue-property-decorator';

import type { IContactPayload, IContactRecord } from '../../../requests';
...
export default class ContactForm extends Vue {
  ...
  protected setForm(data: IContactRecord): void {
    ...
    const { id, nickname, firstName, lastName, email, phoneNumber } = data;
