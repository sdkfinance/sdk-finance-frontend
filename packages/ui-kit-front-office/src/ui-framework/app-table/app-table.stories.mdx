...
<Canvas>
  <Story
    name="Default view"
    args={{ data, columns, isLoading: false }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="Secondary view"
    args={{ data, columns, isSecondary: true }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="Without borders view"
    args={{ data, columns, isBorderNone: true }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="Light Head view"
    args={{ data, columns, isLightHead: true }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="Medium Font view"
    args={{ data, columns, isMediumFont: true }}>
    {Template.bind({})}
  </Story>
</Canvas>
