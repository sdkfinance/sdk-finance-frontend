...
import AppTabLinks from './app-tab-links.vue';
import Vue from 'vue';
...
<Meta
  title="ui-kit/AppTabLinks"
  component={AppTabLinks}
/>
...
<Canvas>
  <Story
    name="Default view"
    args={{ hideForSingle: false, secondary: false, tabs }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    ...
    args={{ hideForSingle: false, secondary: true, tabs: tabsWithBadge }}>
    {Template.bind({})}
  </Story>
</Canvas>
