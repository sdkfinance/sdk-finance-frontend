...
<Meta title="ui-kit/modals/AppModal" component={AppModal}/>
...
<Canvas style={{ position: 'relative' }}>
  <Story name="Default view" args={{ width: '380px', isFixedHeader: false }}>
    { Template.bind({}) }
  </Story>
</Canvas>
...
<Canvas>
  <Story name="With all content scroll and fixed footer and header" args={{  isFixedHeader: true, isFixedFooter: true, }}>
    { Template.bind({}) }
  </Story>
</Canvas>
...
<Canvas>
    <Story name="Fullscreen mode with centered content" args={{ isFullWidth: true, isCentred: true, }}>
        { Template.bind({}) }
    </Story>
</Canvas>
