...
const en: LocaleMessages = {
  ...
  action: {
    ...
    send_payment_link_to_the_client: 'Send payment link to the client',
    download_qr_code_as_image: 'Download QR code as image',
    ...
    create_cash_desk: 'Create cash desk',
    change_profile_photo: 'Change profile photo',
    close_working_day: 'Close working day',
    view_transaction: 'View transaction',
    confirm_close_working_day: 'Confirm closing working day',
    accept_input: 'Accept input',
    make_top_up: 'Make top up',
    make_withdrawal: 'Make withdrawal',
    bulk_edit: 'Bulk edit',
    activate_currency_pair: 'Activate currency pair',
    modify_currency_pair: 'Modify currency pair',
    change_status: 'Change status',
    temp_disable_currency_pair: 'Temporarily disable currency pair',
  ...
  navigation: {
    link: {
      cashier_cash_desk_list: 'Cash desk 1',
      open_working_hours: 'Open working hours',
      close_working_hours: 'Close working hours',
  ...
  pages: {
    coming_soon: {
      ...
      please_note_text: 'Please note, that some features <br> are still in progress.',
    },
    investigations: {
      investigation_details_title: 'Investigation details',
      documents: 'Documents',
    ...
    user_profile_kyc: {
      ...
      confirm_document_upload_modal: {
        ...
        selfie_title: 'Upload selfie confirmation',
        selfie_text: 'Check the selfie before uploading',
    ...
    user_dashboard: {
      ...
      profile: {
        ...
        upload_documents: {
          access_camera: {
            title: 'Press the button to access your camera:',
            subtitle: 'Photos are not stored online unless you choose to share them.',
            prompt: 'Allow access to the camera from the menu above',
          },
        },
      },
      ...
      payments: {
        ...
        corefy: 'Corefy',
        top_up_card_title: 'Top up via card',
    ...
    cfo_cash_desk: {
      create_operation_modal_title: 'Create operation',
      accept_transaction_modal_title: 'Accept transaction',
      request_close_working_day_modal_title: 'Request to close working day',
      modal: {
        delete_confirmation: 'Would you like to delete cashier {cashier}?',
      },
      cash_desk_information: 'Cash desk information',
      edit_cash_desk_details: 'Edit cash desk details',
    },
    cfo_cashier: {
      open_working_hours: 'Open working hours',
      working_hours_title: 'Working hours {date}',
    },
    cfo_asset_rates: {
      rate_source: 'Rate source',
      rate_source_manual: 'Manual',
      rate_source_currency_cloud: 'Currency cloud',
      all_manual_rates_will_be_replaced: 'All manual rates will be replaced',
      modify_rate_for_currency: 'Modify rate for {currency}',
      temp_disabled_rate_pair: 'Temporarily disable asset pair for ({inCurrency}/{outCurrency})',
      rate_list: 'Rate list',
      upload_rates_from_file_modal: {
  ...
  table: {
    ...
    label: {
      ...
      start_at: 'Start at',
      end_at: 'End at',
      operation_requests: 'Operation requests',
      result: 'Result',
      document_status: 'Document status',
      client: 'Client',
      investigation_id: 'Investigation ID',
      close_day_requests: 'Close day requests',
      account_amount: '{currency} account amount',
      start_day_cash_amount: '{currency} start day cash amount',
      end_day_cash_amount: '{currency} end day cash amount',
      ...
      end_working_at: 'End working at',
      request_date: 'Request date',
      accountantName: 'Accountant name',
      processed_date: 'Processed date',
      processed_by_cashier: 'Processed by cashier',
      accountant_name: 'Accountant name',
      from_client_account: 'From client account',
      cash_amount: 'Cash amount',
      balance_currency: 'Balance ({currency})',
      start_working_day_cash_amount_currency: 'Start working hours cash amount ({currency})',
      current_cash_amount_currency: 'Current cash amount ({currency})',
      client_account: 'Client account',
      one_eur_costs: '1 EUR costs',
  ...
  form: {
    label: {
      ...
      validation_call: 'Validation call',
      client_name: 'Client name',
      client_id: 'Client ID',
      account_status: 'Account status',
      kyc_status: 'KYC Status',
  ...
  entity: {
    deactivation_reasons: {
      identification_declined: 'Identification declined',
      user_banned: 'User banned',
